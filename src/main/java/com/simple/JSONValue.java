...
import com.simple.parser.JSONParser;
import com.simple.parser.ParseException;
...
public class JSONValue {
	 ...
	 *
	 * @see com.simple.parser.JSONParser#parse(Reader)
	 ...
	 * Parse JSON text into java object from the input source.
	 *
	 * @see com.simple.parser.JSONParser
	 *
	 * @param in
	 * @return Instance of the following:
	 * 	org.json.simple.JSONObject,
     ...
     *
     * @see com.simple.JSONObject#writeJSONString(Map, Writer)
     * @see com.simple.JSONArray#writeJSONString(List, Writer)
     *
     * @param value
     * @param writer
     */
	 ...
	 *
	 * @see com.simple.JSONObject#toJSONString(Map)
	 * @see com.simple.JSONArray#toJSONString(List)
	 *
	 * @param value

...
public class DTAConnect_ApplicationFunctions {
	...
	public DTAConnect_ApplicationFunctions() {
		/*
	...
	public DTAConnect_ApplicationFunctions(CommonFunctions commonFunctions, Initializer initializer, Stage stage,
			DB dB) {
		this();
...
//	*********************Create online Applications! Generic methods************************************************************************************************************

	// Test Case Name : Create online account

	/**
	 * @author Santhosh Karra
	 */
	public void createYourOnlineAccountButton() {
		try {
			initializer.wait(2);
			...
			initializer.wait(2);
			initializer.successCallwithSnapShot("'Create your Online Account' application is launched successfully");
...
//			initializer.successCallwithSnapShot("Navigate to '" + title + "' page successfully");
			...
			initializer.failureCallwithException("Exception occured in 'login button' Page", e);
		}
	}
	...
	public void loginButton() {
		try {
			initializer.wait(2);
			commonFunctions.getElement(driver, "login.appl").click();
			initializer.infoCall("Clicking 'Create Your Online Account' button sucessfully.");
			initializer.wait(2);
			initializer.successCallwithSnapShot("'Create your Online Account' application is launched successfully");
//			String title = commonFunctions.getElement(driver, "online.title").getText();
//			initializer.successCallwithSnapShot("Navigate to '" + title + "' page successfully");
	...
	public void email_ValidationMsg() {
		try {
			...
			commonFunctions.getElement(driver, "account.email").sendKeys(getWrongEmail());
			commonFunctions.getElement(driver, "account.password").sendKeys("Test@123");
...
//			commonFunctions.getElement(driver, "generic.continue").click();
			...
			String title1 = commonFunctions.getElement(driver, "online.title").getText();
...
//			commonFunctions.getElement(driver, "generic.continue").click();
			...
			String title = commonFunctions.getElement(driver, "account.dob").getText();
			initializer.successCallwithSnapShot("'" + title + "' field validatation successfully.");
	...
	public void email() {
		try {
			commonFunctions.getElement(driver, "account.email").clear();
			String email = getEmail();
			commonFunctions.getElement(driver, "account.email").sendKeys(email);
	...
	public void firstLast_Name() {
		try {
			...
			commonFunctions.getElement(driver, "account.firstname").sendKeys(fname);
			commonFunctions.getElement(driver, "account.lastname").sendKeys(lname);
			initializer.wait(2);
	 ...
	 * @author Santhosh Karra
	 */
	public void onlineAccount_ValidationMsg() {
		try {

			String fname = getName();

			commonFunctions.getElement(driver, "household.fname").sendKeys(fname);
			commonFunctions.getElement(driver, "household.lname").sendKeys("Test@123");
			initializer.wait(2);
			commonFunctions.getElement(driver, "generic.continue").click();
	...
	public void createAccount() {
		try {
			...
			initializer.wait(2);
			initializer.successCallwithSnapShot("Registration completed successfully");
		} catch (Exception e) {
			initializer.failureCallwithException("Exception occured in 'Account creation'", e);
		}
	}

	public void connectToMyDTAinfo() {
		try {
			initializer.wait(2);
			...
			initializer.wait(5);
			initializer.successCallwithSnapShot("Clicked login button successfully");
			initializer.wait(2);
	...
	public void loginApplication() {
		try {
			...
			initializer.successCallwithSnapShot("Clicked login button successfully");
			initializer.wait(3);
			initializer.successCallwithSnapShot("Landing(Interim Report/Recert) Page open successfully");
			initializer.wait(2);
			commonFunctions.getElement(driver, "landing.button").click();
			initializer.wait(2);
			commonFunctions.getElement(driver, "generic.getstarted").click();
			initializer.wait(4);
		} catch (Exception e) {
			initializer.failureCallwithException("Exception occured in 'landing page'", e);
		}
	}

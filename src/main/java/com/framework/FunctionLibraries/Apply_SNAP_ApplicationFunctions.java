...
public class Apply_SNAP_ApplicationFunctions{
	...
	public Apply_SNAP_ApplicationFunctions() {
		/*
	...
	public Apply_SNAP_ApplicationFunctions(CommonFunctions commonFunctions, Initializer initializer, Stage stage,
			DB dB) {
		this();
...
//	*********************About me---Emergency SNAP benefits*****************************************************************************************************
	 ...
	 * @author Santhosh Karra
	 */
//	*********************About me---More about me_1*************************************************************************************************************

	public void language_MoreAboutMe() {
		try {
...
//			deleteRecord_DB(myNumber.split(":")[1].trim());
			commonFunctions.getElement(driver, "fsapplication.download").click();
			initializer.wait(5);
